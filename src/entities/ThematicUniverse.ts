...
export type WorldTypeCode = 'routes' | 'products' | 'funding' | 'community' | 'partner' | 'nft' | 'info' | 'social-media' | 'universe-info' | 'marketboutique' | 'cube-gallery' | 'collection' | 'nft-store' | 'concept-lab' | 'ar-location' | 'quiz'  | 'donate' | 'events' | 'music-collection'
